...
export interface RadarEditionsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "approveEdition"
...
export interface RadarEditions extends BaseContract {
  connect(runner?: ContractRunner | null): RadarEditions;
  waitForDeployment(): Promise<this>;

  interface: RadarEditionsInterface;
